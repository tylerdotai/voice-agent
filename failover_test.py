...
class ComponentFailureTest:
    ...
    def test_ollama_timeout(self) -> dict:
        ...
        try:
            ...
            return {
                "component": "llm",
                "passed": False,
                "notes": "Request should have failed/timeout",
            }
            ...
            return {
                "component": "llm",
                "passed": True,
                "notes": f"Connection error handled: {type(e).__name__}",
            }
        except Exception as e:
            return {
                "component": "llm",
                "passed": True,
                "notes": f"Error handled: {type(e).__name__}",
            }
        ...
        try:
            ...
            try:
                ...
                return {
                    "component": "stt",
                    "passed": True,
                    "notes": f"Exception on empty audio (acceptable): {type(e).__name__}",
                }
        except ImportError:
    ...
    def test_tts_invalid_text(self) -> dict:
        ...
        try:
            ...
            k = Kokoro(
                "/home/tyler/kokoro-onnx/kokoro-v1.0.onnx",
                "/home/tyler/kokoro-onnx/voices-v1.0.bin",
            )
            ...
            try:
                ...
                return {
                    "component": "tts",
                    "passed": True,
                    "notes": f"ValueError on empty (acceptable): {type(e).__name__}",
                }
            except Exception as e:
